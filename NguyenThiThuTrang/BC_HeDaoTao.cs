...
namespace NguyenThiThuTrang {
    ...
    public class BC_HeDaoTao : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "NguyenThiThuTrang.BC_HeDaoTao.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedBC_HeDaoTao : Component, ICachedReport {
        
        public CachedBC_HeDaoTao() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            BC_HeDaoTao rpt = new BC_HeDaoTao();
            rpt.Site = this.Site;
            return rpt;
        }
