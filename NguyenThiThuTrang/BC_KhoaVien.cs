...
namespace NguyenThiThuTrang {
    ...
    public class BC_KhoaVien : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "NguyenThiThuTrang.BC_KhoaVien.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedBC_KhoaVien : Component, ICachedReport {
        
        public CachedBC_KhoaVien() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            BC_KhoaVien rpt = new BC_KhoaVien();
            rpt.Site = this.Site;
            return rpt;
        }
