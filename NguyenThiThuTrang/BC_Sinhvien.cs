...
namespace NguyenThiThuTrang {
    ...
    public class BC_Sinhvien : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "NguyenThiThuTrang.BC_Sinhvien.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedBC_Sinhvien : Component, ICachedReport {
        
        public CachedBC_Sinhvien() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            BC_Sinhvien rpt = new BC_Sinhvien();
            rpt.Site = this.Site;
            return rpt;
        }
